...
public class Course implements Parcelable {
    ...
    public static final Creator<Course> CREATOR = new Creator<Course>() {
        @Override
        public com.uc.myfire.model.Course createFromParcel(Parcel source) {
            return new com.uc.myfire.model.Course(source);
        }

        @Override
        public com.uc.myfire.model.Course[] newArray(int size) {
            return new com.uc.myfire.model.Course[size];
        }
    };
}
