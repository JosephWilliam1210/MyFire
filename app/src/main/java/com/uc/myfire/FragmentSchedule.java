...
import com.uc.myfire.adapter.ScheduleAdapter;
...
public class FragmentSchedule extends Fragment {
    ...
    private void showScheduleData(ArrayList<Course> list){
        rv_schedule_data.setLayoutManager(new LinearLayoutManager(com.uc.myfire.FragmentSchedule.this.getActivity()));
        ScheduleAdapter scheduleAdapter = new ScheduleAdapter(com.uc.myfire.FragmentSchedule.this.getActivity());
