...
import com.uc.myfire.adapter.CourseAdapter;
...
public class CourseData extends AppCompatActivity {
    ...
    private void showCourseData(ArrayList<Course> list) {
        ...
        rv_course_data.setLayoutManager(new LinearLayoutManager(com.uc.myfire.CourseData.this));
        CourseAdapter courseAdapter = new CourseAdapter(com.uc.myfire.CourseData.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == android.R.id.home){
            Intent intent;
            intent = new Intent(com.uc.myfire.CourseData.this, AddCourse.class);
            intent.putExtra("action", "add");
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(com.uc.myfire.CourseData.this);
