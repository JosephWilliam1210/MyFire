...
public class EnrollCA extends RecyclerView.Adapter<EnrollCA.CardViewViewHolder> {
    ...
    public EnrollCA(final Context context) {
    ...
    @NonNull
    @Override
    public EnrollCA.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.enroll_course_adapter, parent, false);
        return new EnrollCA.CardViewViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final EnrollCA.CardViewViewHolder holder, int position) {
