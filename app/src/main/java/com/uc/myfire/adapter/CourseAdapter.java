...
import com.uc.myfire.AddCourse;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CardViewViewHolder>{
    ...
    @NonNull
    @Override
    public com.uc.myfire.adapter.CourseAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.course_adapter, parent, false);
        return new com.uc.myfire.adapter.CourseAdapter.CardViewViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final com.uc.myfire.adapter.CourseAdapter.CardViewViewHolder holder, int position) {
