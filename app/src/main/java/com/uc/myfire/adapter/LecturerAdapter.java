...
import com.uc.myfire.model.Lecturer;
...
public class LecturerAdapter extends RecyclerView.Adapter<LecturerAdapter.CardViewViewHolder>{
    ...
    @NonNull
    @Override
    public com.uc.myfire.adapter.LecturerAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lecturer_adapter, parent, false);
        return new com.uc.myfire.adapter.LecturerAdapter.CardViewViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final com.uc.myfire.adapter.LecturerAdapter.CardViewViewHolder holder, int position) {
