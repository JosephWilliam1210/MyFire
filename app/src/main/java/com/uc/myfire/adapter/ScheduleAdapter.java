...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.CardViewViewHolder>{
    ...
    @NonNull
    @Override
    public com.uc.myfire.adapter.ScheduleAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.enroll_course_adapter, parent, false);
        return new com.uc.myfire.adapter.ScheduleAdapter.CardViewViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull final com.uc.myfire.adapter.ScheduleAdapter.CardViewViewHolder holder, int position) {
